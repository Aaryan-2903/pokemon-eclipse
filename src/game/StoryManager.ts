export enum StoryFlag {
    ...
    OBSERVATORY_MYSTERY_SEEN = 'OBSERVATORY_MYSTERY_SEEN', // Old flag for the non-combat encounter
    ANCIENT_RUINS_UMBRA_ENCOUNTER_SEEN = 'ANCIENT_RUINS_UMBRA_ENCOUNTER_SEEN',
    ANCIENT_RUINS_TABLET_SEEN = 'ANCIENT_RUINS_TABLET_SEEN',
    PROJECT_ECLIPSE_REVEALED = 'PROJECT_ECLIPSE_REVEALED',
    UMBRA_LEADER_TEASER_SEEN = 'UMBRA_LEADER_TEASER_SEEN',
    UMBRA_ENCOUNTER_4_SEEN = 'UMBRA_ENCOUNTER_4_SEEN',
    VISITED_AETHELBURG_MUSEUM = 'VISITED_AETHELBURG_MUSEUM',
